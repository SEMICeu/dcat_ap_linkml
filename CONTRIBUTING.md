# Contributing to dcat-ap

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
dcat-ap. These guidelines are not strict rules.
...
The dcat-ap team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the dcat-ap technical leads
...
[issues]: https://github.com/matentzn/dcat-ap/issues/
[pulls]: https://github.com/matentzn/dcat-ap/pulls/
